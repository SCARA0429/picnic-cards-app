...
export const QUESTION_METADATA = [
  ...
  { id: "v1-deeper-2", volume: 1, category: "Deeper", q: "What would your 5-year-old self say if they saw you now?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "tell_more", disclosureDemand: "moderate", faithSpecific: false, themes: ["childhood", "growth"] },
  ...
  { id: "v1-deeper-7", volume: 1, category: "Deeper", q: "What do you crave more of?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["needs"] },
  ...
  // Relationships (13)
  { id: "v1-relationships-1", volume: 1, category: "Relationships", q: "What do you want to do differently in your next relationship?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["growth", "past_relationships"] },
  ...
  { id: "v1-relationships-4", volume: 1, category: "Relationships", q: "What’s the most important thing you learned from your last heartbreak?", conversationType: "story", answerMode: "both", responseBehaviour: "tell_more", disclosureDemand: "moderate", faithSpecific: false, themes: ["heartbreak", "growth", "past_relationships"] },
  { id: "v1-relationships-5", volume: 1, category: "Relationships", q: "What do all of your exes or previous romantic interests have in common?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["past_relationships", "identity"] },
  ...
  { id: "v1-relationships-8", volume: 1, category: "Relationships", q: "What makes you start trusting someone?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["trust"] },
  { id: "v1-relationships-9", volume: 1, category: "Relationships", q: "What makes you lose trust in someone?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["trust"] },
  ...
  { id: "v1-relationships-12", volume: 1, category: "Relationships", q: "What’s something people often misunderstand about the way you love?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["identity", "love_languages"] },
  ...
  { id: "v2-relationships-4", volume: 2, category: "Relationships", q: "When you need space, what does healthy space look like without making the other person feel shut out?", conversationType: "needs", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["boundaries", "needs", "independence"] },
  { id: "v2-relationships-5", volume: 2, category: "Relationships", q: "When we feel disconnected, what helps you find your way back to me?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["connection", "repair"] },
  ...
  { id: "v2-relationships-9", volume: 2, category: "Relationships", q: "What does a good apology need to include before you genuinely feel repaired with someone?", conversationType: "needs", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["repair", "conflict"] },
  { id: "v2-relationships-10", volume: 2, category: "Relationships", q: "What is something you need more of from me, and something you need less of?", conversationType: "needs", answerMode: "partner_about_you", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: false, themes: ["needs", "honesty"] },
  { id: "v2-relationships-11", volume: 2, category: "Relationships", q: "What makes what we have more than just chemistry?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "affirm", disclosureDemand: "moderate", faithSpecific: false, themes: ["compatibility", "connection"] },
  ...
  { id: "v2-relationships-13", volume: 2, category: "Relationships", q: "Do you feel seen, accepted and chosen by me? Where do you feel that most, and where could I do better?", conversationType: "relationship_reflection", answerMode: "partner_about_you", responseBehaviour: "share", disclosureDemand: "high", faithSpecific: false, themes: ["connection", "accountability"] },
  { id: "v2-relationships-14", volume: 2, category: "Relationships", q: "What makes time together genuinely feel like quality time to you?", conversationType: "needs", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["quality_time", "needs"] },
  { id: "v2-relationships-15", volume: 2, category: "Relationships", q: "How do we love each other deeply without either of us losing ourselves?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["independence", "connection"] },
  { id: "v2-relationships-16", volume: 2, category: "Relationships", q: "What side of yourself does this relationship bring out, and do you like that version of yourself?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "high", faithSpecific: false, themes: ["identity", "growth"] },
  ...
  { id: "v2-relationships-22", volume: 2, category: "Relationships", q: "Are there things you give in this relationship that don’t come naturally to you?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "affirm", disclosureDemand: "moderate", faithSpecific: false, themes: ["sacrifice", "needs"] },
  { id: "v2-relationships-23", volume: 2, category: "Relationships", q: "What makes you feel like we’re actually a team?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "affirm", disclosureDemand: "moderate", faithSpecific: false, themes: ["connection", "compatibility"] },
  ...
  { id: "v2-faith_purpose-2", volume: 2, category: "Faith & Purpose", q: "Since we have been together, do you think this relationship has moved you closer to Christ, distracted you from Him, or neither? Why?", conversationType: "faith_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "high", faithSpecific: true, themes: ["faith", "growth"] },
  { id: "v2-faith_purpose-3", volume: 2, category: "Faith & Purpose", q: "What does being spiritually aligned look like to you in everyday life, beyond simply both being Christian?", conversationType: "faith_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "compatibility", "daily_life"] },
  { id: "v2-faith_purpose-4", volume: 2, category: "Faith & Purpose", q: "Where do you think our spiritual convictions are strongly aligned, and where might we see things differently?", conversationType: "faith_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "compatibility", "differences"] },
  { id: "v2-faith_purpose-5", volume: 2, category: "Faith & Purpose", q: "What do you believe God has placed on your life to do or become in this season?", conversationType: "faith_reflection", answerMode: "both", responseBehaviour: "affirm", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "purpose"] },
  { id: "v2-faith_purpose-6", volume: 2, category: "Faith & Purpose", q: "If our individual callings ever pull us in different directions, how should we decide what faithfulness looks like?", conversationType: "future", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "purpose", "future"] },
  { id: "v2-faith_purpose-7", volume: 2, category: "Faith & Purpose", q: "What would it look like for us to pray, serve and grow spiritually together without performing Christianity for each other?", conversationType: "future", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "honesty", "growth"] },
  { id: "v2-faith_purpose-8", volume: 2, category: "Faith & Purpose", q: "What boundaries do you think would help protect our trust and our relationship with God?", conversationType: "values", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "boundaries", "trust"] },
  ...
  { id: "v2-faith_purpose-12", volume: 2, category: "Faith & Purpose", q: "Who outside our relationship has permission to challenge us or tell us something we may not want to hear?", conversationType: "future", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["accountability", "support"] },
  { id: "v2-faith_purpose-13", volume: 2, category: "Faith & Purpose", q: "In what ways do we help each other grow spiritually, and are there ways we could do that more intentionally?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: true, themes: ["faith", "growth", "support"] },
  { id: "v2-faith_purpose-14", volume: 2, category: "Faith & Purpose", q: "Is the pace of our relationship being driven more by character and clarity, or by chemistry and emotion?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: false, themes: ["compatibility", "attraction"] },
  ...
  { id: "v2-how_you_see_me-3", volume: 2, category: "How You See Me", q: "Where do you think I overthink our relationship, and where do you think my concerns are fair?", conversationType: "perspective", answerMode: "partner_about_you", responseBehaviour: "share", disclosureDemand: "high", faithSpecific: false, themes: ["perception", "honesty"] },
  ...
  { id: "v2-how_you_see_me-7", volume: 2, category: "How You See Me", q: "What do you think we bring out in each other, both good and difficult?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: false, themes: ["connection", "identity"] },
  ...
  { id: "v3-knowing_each_other-2", volume: 3, category: "Knowing Each Other", q: "Do you feel like you know me deeply? Why or why not?", conversationType: "relationship_reflection", answerMode: "partner_about_you", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: false, themes: ["connection", "honesty"] },
  ...
  { id: "v3-needs_expectations-3", volume: 3, category: "Needs & Expectations", q: "What do you think your responsibility is toward my needs?", conversationType: "relationship_reflection", answerMode: "partner_about_you", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["needs", "accountability"] },
  ...
  { id: "v3-needs_expectations-9", volume: 3, category: "Needs & Expectations", q: "How should we tell each other when we're not feeling loved or considered?", conversationType: "future", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["communication", "needs"] },
  ...
  { id: "v3-our_relationship-4", volume: 3, category: "Our Relationship", q: "Do you feel like we're growing together or becoming stagnant? Why?", conversationType: "relationship_reflection", answerMode: "both", responseBehaviour: "share", disclosureDemand: "moderate", faithSpecific: false, themes: ["growth", "compatibility"] },
  ...
  { id: "v3-deeper-4", volume: 3, category: "Deeper", q: "When you realise you're hurting your partner unintentionally, what do you think love requires you to do?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["accountability", "repair"] },
  { id: "v3-deeper-5", volume: 3, category: "Deeper", q: "What does it mean to be a safe person for your partner?", conversationType: "values", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["safety", "trust"] },
  { id: "v3-deeper-6", volume: 3, category: "Deeper", q: "How do you want us to handle conflict when one of us feels hurt?", conversationType: "future", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["conflict", "repair"] },
  { id: "v3-deeper-7", volume: 3, category: "Deeper", q: "What does healthy communication look like when you're overwhelmed?", conversationType: "self_reflection", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["communication", "needs"] },
  ...
  { id: "v3-deeper-10", volume: 3, category: "Deeper", q: "What do you think we owe each other in a relationship?", conversationType: "opinion", answerMode: "both", responseBehaviour: "ask_follow_up", disclosureDemand: "moderate", faithSpecific: false, themes: ["commitment", "accountability"] },
